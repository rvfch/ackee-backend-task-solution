...
export type OpenAPIRouteRequestBody<T> = T extends { post: { requestBody: { content: { 'application/json': infer U } } } } ? U : T extends { put: { requestBody: { content: { 'application/json': infer U } } } } ? U : never
...
export type OpenAPIResponse<T> = T extends {
  ...
  ? U
  : T extends {
      put: { [code: number]: { responses: { content: { 'application/json': infer U } } } }
  }
  ? U
  : T extends {
      delete: { [code: number]: { responses: { content: { 'application/json': infer U } } } }
  }
  ? U
  : T extends {
